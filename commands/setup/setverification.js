    ...
    run: async (bot, message, args) => {
        ...
        try {
            ...
            if (channel.id === a && role.id === b) {
                ...
                bot.guilds.cache.get(message.guild.id).channels.cache.get(channel.id).send(`**\n<a:text:866364286393647114> To Get Verified Type <a:Fleha:866364180948844554> \`${prefix}verify\` <a:text:866364286393647114>,  I hope you enjoy the server <a:Lolibunny:866363290542932008> **`);
